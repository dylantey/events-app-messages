...
const mockMessage = {
    messages: [
        { title: 'Message 1', id: 1, description: 'something really cool' },
        { title: 'Message 2', id: 2, description: 'something even cooler' }
    ]
};
...
const server = app.listen(PORT, () => {
    ...
    console.log(`Message app listening at http://${host}:${port}`);
});
